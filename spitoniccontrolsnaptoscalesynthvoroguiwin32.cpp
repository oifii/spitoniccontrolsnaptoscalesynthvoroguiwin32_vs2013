...
#include "stdafx.h"
#include "spitoniccontrolsnaptoscalesynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitoniccontrolsnaptoscalesynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitoniccontrolsnaptoscalesynthvoroguiwin32class"};				// the main window class name
